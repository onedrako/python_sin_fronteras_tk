...
division = Button(root, text=" / ", fg="#fff", background="#fe9727", command=lambda: press("/"))
division.grid(row=1, column=3, sticky="nswe")
...
multiply.grid(row=2, column=3, sticky="nswe")
...
btn0 = Button(root, text=" 0 ", fg="#fff", background="#666", command=lambda: press(1))
...
plus.grid(row=4, column=3, sticky="nswe")

equal = Button(root, text=" = ", fg="#fff", background="#fe9727", command=equalpress)
equal.grid(row=5, column=3, sticky="nswe")

clear = Button(root, text="Clear", fg="#fff", background="#666", command=lambda: press(1))
